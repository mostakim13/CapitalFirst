                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-primary">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">Earning Account</h5>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-secondary">
                            <div class="card-body">
                                ...
                                <p class="card-text text-white">This Month <i
                    ...
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-success">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">$ 1402.2</h5>
                                <p class="card-text text-white">Total Earning <i class="bi bi-diagram-2 text-primary"></i>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-left-warning bg-danger">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">
                                    $ 100.8 <small><a
                                            href="https://tokyosecurities.com/earning-account/move">Move</a></small> </h5>
                                <p class="card-text text-white">Pending <i class="bi bi-unlock-fill text-danger">
                                        Minimum: 10$ </i></p>
                            </div>
                        </div>
                    </div>
