                                ...
                                <div id="google2faSection">
                                    <div class="main-content-box">
                                        ...
                                        <p>Two factor authentication (2FA) strengthens access security by requiring two
                                            ...
                                            password brute force attacks and secures your logins from attackers exploiting
                                            weak or stolen credentials.</p>
                                        <form method="POST" action="https://tokyosecurities.com/2fa/generateSecret"
                                            id="generate2faSecret">
