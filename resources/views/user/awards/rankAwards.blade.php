                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-primary">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">STARTER</h5>
                                <p class="card-text text-white">Current Rank</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-secondary">
                            <div class="card-body">
                                ...
                                <p class="card-text text-white">Rank Earned</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-success">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">BRONZE</h5>
                                <p class="card-text text-white">Next Rank</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 mb-20">
                        <div class="card border-left-warning bg-danger">
                            <div class="card-body">
                                <h5 class="card-title p-0 pt-4 text-white">+23010
                                    | 2500</h5>
                                <p class="card-text text-white">Points to Next Rank</p>
                            </div>
                        </div>
                    </div>
                </div>
